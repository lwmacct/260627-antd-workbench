...
import { WorkbenchPage, WorkbenchPanel, WorkbenchPasswordSignInForm, WorkbenchPasswordSignUpForm, WorkbenchTokenSignInForm } from "@lwmacct/260627-antd-workbench";
...
export function CredentialFormRoute() {
  ...
  return <WorkbenchPage description={text.components.credentialFormDescription} title={text.components.credentialForm}>
    <Space align="start" size={16} wrap>
      ...
      <WorkbenchPanel><WorkbenchTokenSignInForm onSubmit={() => void message.success(text.components.tokenSubmitted)} /></WorkbenchPanel>
    </Space>
  </WorkbenchPage>;
}
