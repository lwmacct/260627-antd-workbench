...
export { WorkbenchHeaderUtilities } from "./components/shell/WorkbenchHeaderUtilities";
...
export type { WorkbenchHeaderUtilitiesProps } from "./components/shell/WorkbenchHeaderUtilities";
